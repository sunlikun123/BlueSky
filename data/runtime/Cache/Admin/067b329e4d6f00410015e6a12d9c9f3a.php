...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm2" name="form0" method="post" action="<?php echo U('books_runadd');?>"  enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="news_columnid"  class="col-sm-3 selector" required>
								...
								<?php if(is_array($menu)): foreach($menu as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" style="margin-left:55px;"><?php echo ($v["lefthtml"]); echo ($v["title"]); ?></option><?php endforeach; endif; ?>
							</select>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="news_title" id="news_title"  placeholder="必填：图书名称"  class="col-xs-10 col-sm-6" required/>
					...
					<div class="space-4"></div>
						...
						<div class="col-sm-10">
							<input type="text" name="news_cpprice" id="news_cpprice" placeholder="图书价格" class="col-xs-10 col-sm-6" />
						</div>
					</div>
					<div class="space-4"></div>

					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 图书作者：  </label>
						<div class="col-sm-10">
							<input type="text" name="news_auto" id="news_key" placeholder="" class="col-xs-10 col-sm-6" />
						</div>
					</div>
					<div class="space-4"></div>
