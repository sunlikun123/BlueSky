	...
	<div class="page-content">
		<div class="row maintop">
			<div style="margin:10px 0;" id="rule-add">
				<form class="form-horizontal ajaxForm2" name="admin_rule_add" method="post" action="<?php echo U('admin_rule_runadd');?>">
			...
			<div class="row">
				<div class="col-xs-12">
					<div>
						<form class="ajaxForm" name="ruleorder" method="post" action="<?php echo U('cate_order');?>" >
							<table class="table table-striped table-bordered table-hover" id="dynamic-table">
								...
								<?php if(is_array($admin_rule)): foreach($admin_rule as $key=>$v): ?><tr>
										...
										<td class="hidden-xs" style='padding-left:<?php if($v["leftpin"] != 0): echo ($v["leftpin"]); ?>px<?php endif; ?>' ><?php echo ($v["lefthtml"]); echo ($v["title"]); ?></td>
										<td>
											<?php if($v['status'] == 1): ?><a class="red display-btn" href="<?php echo U('admin_rule_state');?>" data-id="<?php echo ($v["id"]); ?>" title="显示">
													<div id="zt<?php echo ($v["id"]); ?>"><button class="btn btn-minier btn-yellow">显示</button></div>
												</a>
												<?php else: ?>
												<a class="red display-btn" href="<?php echo U('admin_rule_state');?>" data-id="<?php echo ($v["id"]); ?>" title="隐藏">
										...
										<td class="hidden-sm hidden-xs"><input name="<?php echo ($v["id"]); ?>" value=" <?php echo ($v["sort"]); ?>" class="list_order"/></td>
										<td>
											<div class="hidden-sm hidden-xs action-buttons">
												<a class="green" href="<?php echo U('cate_edit',array('id'=>$v['id']));?>" title="修改">
													<i class="ace-icon fa fa-pencil bigger-130"></i>
												</a>
												
												<a class="red confirm-rst-url-btn" href="<?php echo U('cate_del',array('id'=>$v['id']));?>" data-info="你确定要删除吗？" title="删除">
											...
											<div class="hidden-md hidden-lg">
												<div class="inline position-relative">
													...
													<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
														<li>
															<a href="<?php echo U('cate_edit',array('id'=>$v['id']));?>" class="tooltip-success" data-rel="tooltip" title="" data-original-title="修改">
																			<span class="green">
...
<!--														<li>
															<a href="<?php echo U('admin_rule_copy',array('id'=>$v['id']));?>" class="tooltip-success" data-rel="tooltip" title="" data-original-title="复制">
																			<span class="green">
														...
														<li>
															<a href="<?php echo U('cate_del',array('id'=>$v['id']));?>"  data-info="你确定要删除吗？" class="tooltip-error confirm-rst-url-btn" data-rel="tooltip" title="" data-original-title="删除">
																			<span class="red">
