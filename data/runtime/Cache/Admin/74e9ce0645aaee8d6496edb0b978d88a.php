...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal adminform" name="admin_list_edit" method="post" action="<?php echo U('admin_runedit');?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="admin_username" id="admin_username"  value="<?php echo ($admin_list["admin_username"]); ?>"  class="col-xs-10 col-sm-5" readonly/>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="admin_pwd" id="admin_pwd" maxlength="15" minlength="6" placeholder="输入登录密码" class="col-xs-10 col-sm-5" />
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="email" name="admin_email" id="admin_email"  value="<?php echo ($admin_list["admin_email"]); ?>"  class="col-xs-10 col-sm-5" required/>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="number" name="admin_tel" id="admin_tel" value="<?php echo ($admin_list["admin_tel"]); ?>"  class="col-xs-10 col-sm-5" required/>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="admin_realname" id="admin_realname" value="<?php echo ($admin_list["admin_realname"]); ?>"  class="col-xs-10 col-sm-5" required/>
