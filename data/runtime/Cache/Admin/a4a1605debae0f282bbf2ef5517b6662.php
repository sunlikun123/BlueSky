				...
				<div class="login-container">
					<div class="center">
						<h1>
							...
							<span class="red">翰林轩书吧</span>
							<span  class="blue" style="font-family:microsoft yahei" id="id-text2">后台管理</span>
						</h1>
					</div>
						...
						<div id="login-box" class="login-box visible widget-box no-border">
							<div class="widget-body">
								<div class="widget-main">
									...
									<div class="space-6"></div>
									<form class="ajaxForm3" name="runlogin" id="runlogin" method="post" action="<?php echo U('runlogin');?>">
										<fieldset>
