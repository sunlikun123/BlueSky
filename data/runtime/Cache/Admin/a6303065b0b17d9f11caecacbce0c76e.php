...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<form name="admin_list_sea" class="form-search form-horizontal" method="post" action="<?php echo U('books_list');?>">
						...
						<div class="table-responsive">
							<table class="table table-striped table-bordered table-hover" id="dynamic-table">
								...
								<?php if(is_array($news)): foreach($news as $key=>$v): ?><tr>
										...
										<td class="hidden-xs">
											<?php if($v['news_open'] == 1): ?><a class="red up-btn" href="<?php echo U('news_state');?>" data-id="<?php echo ($v["n_id"]); ?>" title="上架中">
													<div id="zt<?php echo ($v["n_id"]); ?>"><button class="btn btn-minier btn-yellow">上架中</button></div>
												</a>
												<?php else: ?>
												<a class="red up-btn" href="<?php echo U('news_state');?>" data-id="<?php echo ($v["n_id"]); ?>" title="下架">
										...
										<td>
											<div class="hidden-sm hidden-xs action-buttons">
												...
												<a class="red confirm-rst-url-btn" data-info="你确定要删除到回收站吗？" href="<?php echo U('books_del',array('n_id'=>$v['n_id'],'p'=>I('p',1)));?>" title="回收站">
