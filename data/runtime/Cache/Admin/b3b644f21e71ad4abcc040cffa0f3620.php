						...
						<div class="table-responsive">
							<table class="table table-striped table-bordered table-hover" id="dynamic-table">
								...
								<?php if(is_array($news)): foreach($news as $key=>$v): ?><tr>
										...
										<td><a href="" target="_blank" title="<?php echo ($v["news_title"]); ?>"><?php echo (subtext($v["title"],25)); ?></a></td>
										
										<td class="hidden-xs"><?php echo (date('Y-m-d',$v["create_at"])); ?></td>
										<td>
											<div class="hidden-sm hidden-xs action-buttons">
												<a class="green" href="<?php echo U('news_edit',array('n_id'=>$v['n_id']));?>" title="修改">
													<i class="ace-icon fa fa-pencil bigger-130"></i>
												</a>
												<a class="red confirm-rst-url-btn" data-info="你确定要删除该公告吗？" href="<?php echo U('news_del',array('n_id'=>$v['n_id'],'p'=>I('p',1)));?>" title="回收站">
