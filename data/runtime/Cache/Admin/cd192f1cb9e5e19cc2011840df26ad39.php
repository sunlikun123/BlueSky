...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<form name="admin_list_sea" class="form-search form-horizontal" method="post" action="<?php echo U('news_list');?>">
						...
						<div class="table-responsive">
							<table class="table table-striped table-bordered table-hover" id="dynamic-table">
								...
								<?php if(is_array($news)): foreach($news as $key=>$v): ?><tr>
										...
										<td><a href="" target="_blank" title="<?php echo ($v["news_title"]); ?>"><?php echo (subtext($v["news_title"],25)); ?></a>【<?php echo ((isset($v['admin_realname']) && ($v['admin_realname'] !== ""))?($v['admin_realname']):$v['admin_username']); ?>】</td>
										...
										<td class="hidden-xs">
											<?php if($v['news_open'] == 1): ?><a class="red state-btn" href="<?php echo U('news_state');?>" data-id="<?php echo ($v["n_id"]); ?>" title="已审">
													<div id="zt<?php echo ($v["n_id"]); ?>"><button class="btn btn-minier btn-yellow">已审</button></div>
												</a>
												<?php else: ?>
												<a class="red state-btn" href="<?php echo U('news_state');?>" data-id="<?php echo ($v["n_id"]); ?>" title="未审">
										...
										<td>
											<div class="hidden-sm hidden-xs action-buttons">
												<a class="green" href="<?php echo U('news_edit',array('n_id'=>$v['n_id']));?>" title="修改">
													<i class="ace-icon fa fa-pencil bigger-130"></i>
												</a>
												<a class="red confirm-rst-url-btn" data-info="你确定要删除到回收站吗？" href="<?php echo U('news_del',array('n_id'=>$v['n_id'],'p'=>I('p',1)));?>" title="回收站">
											...
											<div class="hidden-md hidden-lg">
												<div class="inline position-relative">
													...
													<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
														<li>
															<a href="<?php echo U('news_edit',array('n_id'=>$v['n_id']));?>" class="tooltip-success" data-rel="tooltip" title="" data-original-title="修改">
																			<span class="green">
														...
														<li>
															<a href="<?php echo U('news_del',array('n_id'=>$v['n_id'],'p'=>I('p',1)));?>" data-info="你确定要删除到回收站吗？" class="tooltip-error confirm-rst-url-btn" data-rel="tooltip" title="" data-original-title="回收站">
																			<span class="red">
