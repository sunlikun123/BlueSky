...
<body>
	...
	<div class="mainBody">
		<?php if(is_array($sell)): $i = 0; $__LIST__ = $sell;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="mainBodyLi">
	...
	<div class="bottomNav">
		...
		<a class="ce9" href="<?php echo U('Book/hotsell');?>">畅销</a>
